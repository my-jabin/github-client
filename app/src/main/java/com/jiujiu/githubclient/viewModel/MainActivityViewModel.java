...
public class MainActivityViewModel extends ViewModel {
    ...
    public MainActivityViewModel() {
        dataRepository = InjectionUtil.providesDataRepository();
    }
    ...
    public void showRepository(String ownerName) {
        ...
        currentOwner = dataRepository.getOwner(ownerName);
        owner.addSource(currentOwner, ownerEntity -> owner.setValue(ownerEntity));
    }

    public void deleteAllRecords() {
        Disposable d = Completable.fromRunnable(() -> dataRepository.deleteAllRecords())
